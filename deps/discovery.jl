...
function library_versioned_names(name::String, version::Union{Nothing,VersionNumber}=nothing)
    names = String[]
    if Sys.iswindows()
...
"""
function find_library(name::String, version::Union{Nothing,VersionNumber}=nothing;
